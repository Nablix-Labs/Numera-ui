          ...
          <div className="p-4">
            {!submitted ? (
              <>
                ...
                <button
                  ...
                  className={
                    ...
                    (text.trim() ? 'bg-focus-navy text-white hover:opacity-80' : 'bg-muted-gray text-slate-blue')
                  }
                >
                  Share with tutor
                </button>
              ...
              <div className="flex items-start gap-2.5">
                <span className="flex-shrink-0 mt-0.5 w-5 h-5 rounded-full bg-success-sage text-white flex items-center justify-center">

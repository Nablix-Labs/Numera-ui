  ...
  return (
    <main className="flex-1 min-w-0 flex items-center justify-center bg-white p-8" aria-label="Welcome">
      <div className="w-[460px] max-w-full">
        <div className="text-[10px] tracking-widest uppercase text-slate-blue mb-2">Welcome to Numera</div>
        ...
        <label className="block mt-6 text-[12px] font-semibold text-ink">
          ...
          <input
            ...
            className="mt-1.5 w-full rounded-md border border-muted-gray bg-white px-3.5 py-2.5 text-[14px] text-ink placeholder:text-slate-blue focus:border-focus-navy focus:outline-none transition-colors"
          />
        </label>
        ...
        <button
          ...
          className="mt-5 w-full rounded-md bg-focus-navy text-white px-4 py-3 text-[13px] font-semibold hover:opacity-80 disabled:opacity-30 disabled:cursor-not-allowed transition-opacity"
        >
          Start diagnostic
        </button>
      </div>

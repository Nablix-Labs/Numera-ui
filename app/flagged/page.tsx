...
const FLAGGED: Flagged[] = [
  { equation: '3(x − 2) = 9', topic: 'Expanding Brackets', reason: 'Got stuck expanding', when: 'Today' },
  { equation: '2x + 5 = 13', topic: 'Solving for x', reason: 'Want to revisit', when: 'Yesterday' },
  { equation: '7/8 − 1/3', topic: 'Fractions', reason: 'Common denominator', when: '2 days ago' },
  { equation: 'x² − 5x + 6 = 0', topic: 'Quadratics', reason: 'For later', when: '4 days ago' },
];
...
export default function FlaggedPage() {
  return (
    <PageShell
      title="Flagged"
      subtitle="Problems you saved to come back to."
